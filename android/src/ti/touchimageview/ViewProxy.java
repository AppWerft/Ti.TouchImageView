...
@Kroll.proxy(creatableInModule = TiTouchImageViewModule.class, propertyAccessors = {
		"zoom", "image", "maxZoom", "minZoom" })
public class ViewProxy extends TiViewProxy {
	...
	private class TiTouchImageView extends TiUIView {
		...
		public TiTouchImageView(final TiViewProxy proxy) {
			...
			tiv.onTouchEvent(MotionEvent event);
			setNativeView(tiv);
		}
		...
		private String getPathToApplicationAsset(String assetName) {
			...
			// specified
			// path with the proxy context. This locates a resource relative to
			// the
	...
	public void scrollTo(int x, int y) {
		if (!TiApplication.isUIThread()) {
			TiMessenger.sendBlockingMainMessage(
					getMainHandler().obtainMessage(MSG_SCROLL_TO, x, y),
					getActivity());
		} else {
			handleScrollTo(x, y);
		}
